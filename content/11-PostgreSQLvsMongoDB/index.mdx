...
For more insights please click on eany of the [MongoDB](https://www.mongodb.com/docs/) or [PostgreSQL](https://www.postgresql.org/) text they link straight to their respective documentation.
 ...
 PS 
- These are just some tips I wanted to pass on from my time working at [iServiceWeb](https://www.iserviceweb.io/). Being that my first work was with PostgreSQL and my inernship being with [MongoDB](https://www.mongodb.com/docs/). 
