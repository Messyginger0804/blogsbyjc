...
const AboutCover = () => {
    return (
        <section className='w-full h-full lg:h-[75vh] border-b-2 border-solid border-dark dark:border-light flex flex-col lg:flex-row items-center justify-center text-dark dark:text-light'>
            <div className='w-full md:w-1/3 lg:w-1/2 h-full border-b-2 lg:border-b-0 lg:border-r-2 border-solid border-dark dark:border-light flex justify-center'>
                <Image
                    className='w-4/5 xs:w-3/4 md:w-2/3 lg:w-full h-full object-contain object-center'
            ...
            <div className='w-full lg:w-1/2 flex flex-col text-left items-start justify-center px-5 xs:p-10 pb-10 lg:px-16 lg:h-[75vh] overflow-y-auto'>
                <div className='flex flex-col items-start mt-5 lg:mt-0 overflow-y-auto max-h-full'>
