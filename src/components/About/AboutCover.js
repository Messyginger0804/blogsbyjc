...
const AboutCover = () => {
    return (
        <section className="w-full h-auto lg:h-[75vh] min-h-[50vh] border-b-2 border-solid border-dark dark:border-light flex flex-col lg:flex-row items-center justify-center text-dark dark:text-light mt-20">
            <div className="flex justify-center items-center lg:justify-start mx-auto bg-gradient-to-b from-accent dark:from-accentDark rounded-full w-80 h-80 relative overflow-hidden md:h-96 md:w-96">
                <Image
            ...
            <div className='w-full lg:w-1/2 flex flex-col text-left items-start justify-center px-5 xs:px-10 pb-10 lg:px-16 lg:h-[75vh] min-h-[50vh]'>
                <div className='mt-5 lg:mt-0 h-full overflow-y-auto'>
